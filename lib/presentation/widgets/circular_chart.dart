...
class _CircularChartState extends State<CircularChart> {
  ...
  Widget build(BuildContext context) {
    if ((widget.title == 'Income' || widget.title == 'Thu nhập') && incomeData.isEmpty) {
      return SizedBox(
    ...
    } else if ((widget.title == 'Expense' || widget.title == 'Chi tiêu') && expenseData.isEmpty) {
      return Padding(
    ...
    return SizedBox(
        ...
        child: SfCircularChart(
            palette: widget.title == 'Income' || widget.title == 'Thu nhập'
                ? const <Color>[
            ...
            title: ChartTitle(
                ...
                textStyle: TextStyle(
                    color:
                        (widget.title == 'Income' || widget.title == 'Thu nhập') ? Colors.green : Colors.red)),
            ...
            series: <CircularSeries>[
              ...
              DoughnutSeries<ChartData, String>(
                  dataSource:
                      (widget.title == 'Income' || widget.title == 'Thu nhập') ? incomeData : expenseData,
